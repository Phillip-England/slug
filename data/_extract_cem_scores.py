...
def extract_cem_scores(self, config):
    ...
    if os.path.exists(config.cem_report_download_path_current_month) and os.path.exists(config.cem_report_download_path_ninty_day_rolling) and os.path.exists(config.cem_report_download_path_year_to_date):
        ...
        self.cems['cm_osat'] = 'N/A'
        self.cems['cm_taste'] = 'N/A'
        self.cems['cm_number_of_surveys'] = '0'
        self.cems['cm_speed'] = 'N/A'
        self.cems['cm_ace'] = 'N/A'
        self.cems['cm_cleanliness'] = 'N/A'
        self.cems['cm_accuracy'] = 'N/A'
        self.cems['ndr_osat'] = 'N/A'
        self.cems['ndr_taste'] = 'N/A'
        self.cems['ndr_number_of_surveys'] = '0'
        self.cems['ndr_speed'] = 'N/A'
        self.cems['ndr_ace'] = 'N/A'
        self.cems['ndr_cleanliness'] = 'N/A'
        self.cems['ndr_accuracy'] = 'N/A'
        self.cems['ytd_osat'] = 'N/A'
        self.cems['ytd_taste'] = 'N/A'
        self.cems['ytd_number_of_surveys'] = '0'
        self.cems['ytd_speed'] = 'N/A'
        self.cems['ytd_ace'] = 'N/A'
        self.cems['ytd_cleanliness'] = 'N/A'
        self.cems['ytd_accuracy'] = 'N/A'
